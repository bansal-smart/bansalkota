      ...
      CASE COALESCE(q.question_type, 'mcq-single')
        WHEN 'mcq-multi' THEN
          ...
          ELSIF q.partial_marking AND correct_picked > 0 THEN
            -- JEE Adv per client: 4-correct questions give +1 per correct pick;
            -- 2- or 3-correct questions give a flat +1 for any partial (no wrong).
            IF correct_count_arr >= 4 THEN
