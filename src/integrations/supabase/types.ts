  ...
  public: {
    Tables: {
      ...
      batch_centre_visibility: {
        ...
        Relationships: [
          {
            foreignKeyName: "batch_centre_visibility_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "batch_centre_visibility_centre_id_fkey"
            columns: ["centre_id"]
            isOneToOne: false
      ...
      live_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "live_classes_centre_id_fkey"
            columns: ["centre_id"]
            isOneToOne: false
            referencedRelation: "centres"
            referencedColumns: ["id"]
      ...
      test_series_images: {
        ...
        Relationships: [
          {
            foreignKeyName: "test_series_images_test_series_id_fkey"
    ...
    Enums: {
      app_role:
        ...
        | "mentor"
        | "center_admin"
      batch_visibility: "global" | "centre_specific" | "disabled"
