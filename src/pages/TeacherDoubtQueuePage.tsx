...
const doubts = [
  { id: 1, student: "Arjun Mehta", class: "12th", batch: "JEE 2026 A", subject: "Physics", topic: "Electrostatics", question: "Sir, how do I apply Gauss's law to find the electric field due to a non-uniformly charged sphere? I tried using the formula but the symmetry argument doesn't seem to work here.", time: "2h ago", urgent: true, status: "pending", hasImage: true, aiAnswer: "To apply Gauss's Law for non-uniform charge distribution, you need to consider the charge enclosed within a Gaussian surface. For a sphere with charge density ρ(r), integrate ρ from 0 to r to find Q_enc, then use E·4πr² = Q_enc/ε₀." },
  { id: 2, student: "Priya Sharma", class: "12th", batch: "NEET 2026", subject: "Chemistry", topic: "Organic Reactions", question: "Why does SN1 reaction prefer tertiary carbon over primary? Isn't the primary carbon more accessible for the nucleophile?", time: "4h ago", urgent: false, status: "pending", hasImage: false, aiAnswer: null },
  { id: 3, student: "Rahul Singh", class: "11th", batch: "JEE 2027", subject: "Physics", topic: "Optics", question: "Can you explain the difference between real and virtual images in concave mirrors with ray diagrams?", time: "6h ago", urgent: false, status: "pending", hasImage: false, aiAnswer: null },
  { id: 4, student: "Sneha Gupta", class: "12th", batch: "NEET 2026", subject: "Biology", topic: "Genetics", question: "How do we determine if a trait is autosomal dominant or recessive from a pedigree chart?", time: "12h ago", urgent: true, status: "answered", hasImage: true, aiAnswer: null },
  { id: 5, student: "Vikram Joshi", class: "12th", batch: "JEE 2026 B", subject: "Mathematics", topic: "Integration", question: "How to solve integration by partial fractions when the denominator has repeated roots?", time: "1d ago", urgent: false, status: "answered", hasImage: false, aiAnswer: null },
];
