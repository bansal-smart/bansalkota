...
// A centre's own news feed (centre_updates table), shown on its public centre
// page. Reached from /admin/news-updates — centre_admin-only in practice (RLS
// scopes reads/writes to their own centre; there's no cross-centre picker here).
