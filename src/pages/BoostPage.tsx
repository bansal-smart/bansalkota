...
const benefits = [
  ...
  },
  {
    ...
    desc: "All registrants receive a Bansal Foundation booklet and exclusive practice sheets.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Whether you're starting your foundation in Class 6 or fine-tuning for your final JEE / NEET attempt —
                BOOST has a track for you.
              </p>
              ...
              <BansalCard key={p.mode}>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-bansal-black">{p.duration}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Questions</span>
                    <span className="font-semibold text-bansal-black">{p.questions}</span>
                  </div>
                  <div>
