        ...
        <div className={`relative z-10 ${CONTAINER} pb-14 md:pb-20 pt-28`}>
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-2xl">
              Founded in Kota in 1981 by Shri V.K. Bansal, we built the institution that turned a town into a national symbol of academic excellence.
            </p>
          ...
          <div className="grid gap-10 md:gap-14 md:grid-cols-12 items-center">
            ...
            <div className="md:col-span-7">
              ...
              <div className="mt-5 space-y-4 text-base md:text-lg text-bansal-gray leading-relaxed">
                <p>
                  Born on 26 October 1949 in Jhansi, Shri V.K. Bansal graduated from IIT (BHU) Varanasi and moved to Kota to work at J.K. Synthetics. In <strong>1981</strong>, he began coaching a handful of students — and quietly created a movement that would redefine engineering education in India.
                </p>
                <p>
          ...
          <div className="grid gap-10 lg:gap-14 lg:grid-cols-12 items-center">
            <div className="lg:col-span-5 order-2 lg:order-1">
              ...
              <p className="mt-5 text-white/85 leading-relaxed text-base md:text-lg max-w-xl">
                A front-page Wall Street Journal feature on how Kota — and the man behind it, V.K. Bansal — transformed Indian competitive education. A story read across the world.
              </p>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="relative">
                ...
                <img
                  ...
                  alt="Wall Street Journal feature on V.K. Bansal and Kota coaching"
          ...
          <div className="grid gap-10 md:gap-14 md:grid-cols-12 items-start">
            <div className="md:col-span-7">
              ...
              <div className="space-y-4 text-base md:text-lg text-bansal-gray leading-relaxed">
                <p>
                  In 1981, V.K. Bansal recognised the need to provide proper guidance to JEE aspirants and dedicated himself to this cause. With his discipline and positive attitude, Bansal Classes produced remarkable results year after year — each batch challenging the next to perform even better.
                </p>
                <p>
            ...
            <div className="md:col-span-5">
              <figure className="rounded-xl overflow-hidden bg-white shadow-md border border-border">
                <img
                  ...
                  alt="Shri V.K. Bansal with Shri Ashok Gehlot, former Chief Minister of Rajasthan"
                  className="w-full h-auto object-cover"
                  loading="lazy"
                />
                <figcaption className="p-4 text-xs text-bansal-gray border-t border-border">
                  Shri V.K. Bansal in conversation with <strong className="text-bansal-blue">Shri Ashok Gehlot</strong>, former Chief Minister of Rajasthan.
                </figcaption>
              </figure>
            </div>
          </div>
