...
const chatMessages = [
  { name: "Arjun", message: "Sir, I have a doubt in this question I posted in doubts tab", color: "bg-primary" },
  { name: "Priya", message: "Sir you teach it so well!", color: "bg-secondary" },
  { name: "Rahul", message: "Please explain the derivation again", color: "bg-accent" },
  { name: "Ramesh Sir", message: "Let me explain step by step...", color: "bg-[hsl(var(--navy))]", isTeacher: true },
  { name: "Sneha", message: "Got it! Thank you sir", color: "bg-destructive" },
  { name: "Amit", message: "Can you share the notes for this topic?", color: "bg-primary" },
  { name: "Ramesh Sir", message: "Notes will be uploaded after class", color: "bg-[hsl(var(--navy))]", isTeacher: true },
  { name: "Kavita", message: "When is the next test on this chapter?", color: "bg-secondary" },
];
...
const LiveClassRoomPage = () => {
  ...
  return (
    <div className="pb-20 lg:pb-0">
      {/* Top Bar */}
      <div className="bg-[hsl(var(--navy))] px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-white/60">Physics — Ramesh Kumar</p>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1">
          <div className="relative aspect-video bg-[#0a0a0a] flex items-center justify-center">
            <div className="text-center">
              <div className="h-20 w-20 rounded-full bg-gradient-to-br from-primary to-primary-dark mx-auto flex items-center justify-center mb-3">
                <span className="text-2xl font-bold text-white">RK</span>
              </div>
              <p className="text-white/60 text-sm">Ramesh Kumar is presenting</p>
            </div>
            {/* Overlays */}
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <LiveBadge />
                <span className="text-xs text-white/70">Ramesh Kumar — Physics</span>
        ...
        <div className="lg:w-[340px] border-l border-border bg-card flex flex-col h-[50vh] lg:h-[calc(100vh-57px-48px)]">
          ...
          <div className="px-4 py-2 text-[10px] text-secondary">
            <p>Amit, Akshatha, Anukriti & 16 others joined</p>
          </div>
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-t border-border">
            ...
            <button className="rounded-lg bg-primary p-2 text-primary-foreground hover:bg-primary-dark transition-colors"><Send className="h-4 w-4" /></button>
          </div>
        </div>
      </div>
    </div>
