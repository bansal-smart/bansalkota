      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-8 md:mb-10">
          <BansalBadge tone="blue">
            <Building2 className="h-3 w-3 mr-1" /> Pan-India
          </BansalBadge>
          ...
          <p className="mt-2 text-sm md:text-base text-bansal-gray">
            100+ centres across India — every one staffed with master mentors, libraries and the same Bansal curriculum
            that built Kota.
          </p>
            ...
            {featured.length > 0 && (
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wide text-bansal-orange">
                    Flagship Centre{featured.length > 1 ? "s" : ""}
                  </span>
                </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="font-display text-2xl font-extrabold leading-tight">
                            {c.city}{" "}
                            {c.is_hq && <span className="text-[10px] text-bansal-orange ml-1 align-middle">HQ</span>}
                          </div>
        ...
        <div className="mt-8 text-center">
          <Link
            to="/centres"
            className="inline-flex items-center gap-1 text-sm font-semibold text-bansal-blue hover:text-bansal-orange"
          >
