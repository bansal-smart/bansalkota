...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Dark Navy Sidebar */}
      <aside className="hidden lg:flex w-[240px] flex-col sticky top-0 h-screen overflow-y-auto" style={{ backgroundColor: "hsl(222, 47%, 11%)" }}>
        <div className="p-4">
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-white truncate">{user?.email ?? "Staff"}</p>
