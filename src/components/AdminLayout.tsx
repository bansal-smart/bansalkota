...
const baseNav: NavItem[] = [
  ...
  { label: "All Tests", icon: ClipboardCheck, path: "/admin/tests" },
  { label: "Test Series", icon: Trophy, path: "/admin/test-series" },
  { label: "Test Attempts", icon: FileBarChart, path: "/admin/test-attempts" },
  { label: "Question Bank", icon: Library, path: "/admin/question-bank" },
  { label: "Import Batches", icon: FileText, path: "/admin/test-imports" },
